...
import Pr3NomCheckersPr3NomCheckersCheckers from './Pr3Nom/checkers/pr3nom.checkers.checkers'
...
export default { 
  Pr3NomCheckersPr3NomCheckersCheckers: load(Pr3NomCheckersPr3NomCheckersCheckers, 'pr3nom.checkers.checkers'),
